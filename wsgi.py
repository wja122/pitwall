...
from modules.setup.module import SetupModule
...
registry.discover()
widget_registry.discover()

_driver = DisplayDriver(_config)

if not _config.get('setup_complete', False) or _config.get('show_setup_qr', False):
    _driver.set_module(SetupModule())
else:
